...
User.create!(nickname: "anajrum", password: "123456", email: 'murjana@gmail.com', gender: "female", preferred_date_ideas: "We stay in and I teach you how to use figma!", orientation: "heterosexual",  about_me: "Former Tv journalist who turned into tech companies( operations side) with a passion to get more technical and more into learning how to build great projects!", age: 25)
User.create!(nickname: "alosif", password: "123456", email: 'fisola@gmail.com', gender: "male", preferred_date_ideas: "A wild night out on the town!", orientation: "heterosexual",  about_me: "I recently completed a master's degree in Sustainable Forest and Nature Management at the University of Gottingen, Germany. Before my master's degree ended, I decided to pursue my long-term interest in coding.", age: 25)
